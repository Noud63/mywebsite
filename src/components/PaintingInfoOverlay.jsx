    ...
    >
      ...
      >
        <div className="flex flex-col items-center border-b border-black pb-2 mb-2">
          <h2
            className={`${id === "theexpansionoftheuniverse" ? "max-xsm:flex-col items-center" : ""} 
        ...
        <div className="absolute bottom-2 text-sm text-gray-600 max-sm:text-[10px] max-sm:bottom-1">
          &copy;noud van dun
        </div>
      </section>
    </div>
