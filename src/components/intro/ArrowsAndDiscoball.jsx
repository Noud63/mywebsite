...
const ArrowsAndDiscoball = () => {
  return (
    <div className="allpaintings flex flex-col pl-10 pr-12 py-8 text-blue-950 text-xl max-sm:text-lg text-center px-4 max-sm:py-4 max-sm:px-6 max-sm:items-center">
      ...
      <div className="flex justify-between">
         ...
         {/* <div className="flex justify-center h-[40px] w-[20px] hidden max-sm:flex mt-2">
          ...
          <span>All works with title bar by: <br /><span className="font-semibold ">&copy;Noud van Dun </span></span>
          </div>
          {/* <div className="flex justify-center h-[40px] w-[20px] hidden max-sm:flex mt-2">
          <img src="images/arrow_small.png" alt="" className="downarrow" />
        </div> */}
